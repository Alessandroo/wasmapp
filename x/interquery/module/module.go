...
import (
	...
	modulev1 "wasmapp/api/wasmapp/interquery/module"
	"wasmapp/x/interquery/client/cli"
...
type ModuleOutputs struct {
	...
	InterqueryKeeper keeper.Keeper
...
func ProvideModule(in ModuleInputs) ModuleOutputs {
	...
	return ModuleOutputs{InterqueryKeeper: k, Module: m}
}
