...
const (
	Query_Params_FullMethodName        = "/wasmapp.interquery.Query/Params"
	Query_QueryIcqState_FullMethodName = "/wasmapp.interquery.Query/QueryIcqState"
)
...
func (c *queryClient) QueryIcqState(ctx context.Context, in *QueryIcqStateRequest, opts ...grpc.CallOption) (*QueryIcqStateResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_QueryIcqState_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) QueryIcqState(context.Context, *QueryIcqStateRequest) (*QueryIcqStateResponse, error) {
...
func _Query_QueryIcqState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_QueryIcqState_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
