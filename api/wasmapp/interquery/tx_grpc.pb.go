...
const (
	Msg_UpdateParams_FullMethodName         = "/wasmapp.interquery.Msg/UpdateParams"
	Msg_SendQueryAllBalances_FullMethodName = "/wasmapp.interquery.Msg/SendQueryAllBalances"
)
...
func (c *msgClient) SendQueryAllBalances(ctx context.Context, in *MsgSendQueryAllBalances, opts ...grpc.CallOption) (*MsgSendQueryAllBalancesResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_SendQueryAllBalances_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMsgServer) SendQueryAllBalances(context.Context, *MsgSendQueryAllBalances) (*MsgSendQueryAllBalancesResponse, error) {
...
func _Msg_SendQueryAllBalances_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_SendQueryAllBalances_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
