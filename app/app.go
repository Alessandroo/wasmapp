...
func New(
	...
	if err := app.RegisterStores(
		storetypes.NewKVStoreKey(tokenmoduletypes.StoreKey),
	); err != nil {
		panic(err)
	}
	...
	app.TokenKeeper = tokenmodulekeeper.NewKeeper(
		app.AppCodec(),
		runtime.NewKVStoreService(app.GetKey(tokenmoduletypes.StoreKey)),
		logger,
		app.WasmKeeper,
		authtypes.NewModuleAddress(tokenmoduletypes.ModuleName).String(),
	)
